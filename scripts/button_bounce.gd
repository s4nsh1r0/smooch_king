...
func _ready():
	original_position = position # Store the button's original position
	original_modulate = modulate # Store the button's original modulate color
	# Connect the mouse signals for hover effect
